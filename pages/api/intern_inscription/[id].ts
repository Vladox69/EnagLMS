...
const getInternInscription = async (
  req: NextApiRequest,
  res: NextApiResponse<Data>
) => {
  try {
...
const getInternInscriptionByIdCourse = async (
  req: NextApiRequest,
  res: NextApiResponse<Data>
) => {
  try {
...
const getInternInscriptionsByIdStudent = async (
  req: NextApiRequest,
  res: NextApiResponse<Data>
) => {
  try {
...
const deleteInternInscriptionById = async (
  req: NextApiRequest,
  res: NextApiResponse<Data>
) => {
  try {
...
const deleteInscriptionByIdCourse = async (
  req: NextApiRequest,
  res: NextApiResponse<Data>
) => {
  try {
    const { id } = req.query;
    const course_id = id?.toString().substring('course_id='.length)
    const inscription = await prisma.intern_inscription.deleteMany({
        where: {
            course_id: Number(course_id)
        }
    })
