...
const getResourceByIdActivity = async (
  req: NextApiRequest,
  res: NextApiResponse<Data>
) => {
  try {
...
const deleteResourceByIdActivty = async (
  req: NextApiRequest,
  res: NextApiResponse<Data>
) => {
  try {
    ...
    console.log("all resource activities");
    console.log(activities_temp);
    ...
    return res
      ...
      .json({
        ...
        count: activity_resources.count,
      });
  } catch (error) {
    console.log(error);
