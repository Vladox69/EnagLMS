...
import { Typography, Container, Button, Dialog, DialogTitle, DialogContent } from '@mui/material';
    ...
    <Layout title='My activity'>
      <Container className='container bg-primary' >
        <Container className='container bg-danger' >
          ...
          <Button variant='contained' onClick={handleOpen}> Añadir recurso </Button>
